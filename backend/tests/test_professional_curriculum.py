...
EXPECTED = [
    ...
    ("P8.1", "F9.9"), ("P8.2", "F9.10"), ("P8.3", None), ("P8.4", None), ("P8.5", None), ("P8.6", None), ("P8.7", "F9.11"), ("P8.8", None),
    ("P9.1", None),
    ("P10.1", None), ("P10.2", None),
    ("P11.1", None), ("P11.2", None), ("P11.3", None), ("P11.4", None),
    ("P12.1", None), ("P13.1", None),
]


def test_professional_registry_copies_the_foundations_lessons():
    assert [module["id"] for module in MODULES] == ["P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9", "P10", "P11", "P12", "P13"]
    ...
    for lesson in LESSONS:
        ...
        elif source and "sourceProfessionalLessonId" not in source:
    ...
    assert [lesson["renderer"] for lesson in LESSONS if lesson["moduleId"] in ("P8", "P9", "P10") and lesson["id"] != "P8.8"] == [
