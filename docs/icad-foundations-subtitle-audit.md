...
Mouse Opertaions, Standard Views, and Creating Basic Shapes are lesson groups. Their child lessons are covered above; the group labels do not define separate caption styles.
