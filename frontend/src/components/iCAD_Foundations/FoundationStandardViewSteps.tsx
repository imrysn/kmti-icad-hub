...
export default function FoundationStandardViewSteps({text, japanese}: {text: string; japanese: boolean}) {
  ...
  return <><FoundationStartingSteps sections={sections} japanese={japanese} />
