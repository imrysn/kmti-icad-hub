...
export const ZOOM_IN_OUT_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  ...
  quickReviewText: '<b>Mouse Wheel Forward</b> → <b>Zoom In</b> │ <b>Mouse Wheel Backward</b> → <b>Zoom Out</b>',
...
export const PAN_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  title: 'Pan',
  description: 'is used to move the drawing or 3D model across the screen without changing its size or position in the model.',
  procedureTitle: 'ivl-objective',
  objective: 'By the end of this lesson, you will be able to move the view around the workspace using Pan.',
  quickReviewTitle: 'Quick Review',
  quickReviewText: '<b>Hold Scroll Wheel</b> → <b>Drag Mouse</b> → <b>Release</b>',
...
export const ROTATE_VIEW_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  title: 'Rotate View',
  description: 'allows you to view a 3D model from different angles without changing the actual model.',
  procedureTitle: 'ivl-objective',
  objective: 'By the end of this lesson, you will be able to rotate a 3D model and inspect it from different directions.',
  quickReviewTitle: 'Quick Review',
  quickReviewText: '<b>Hold Scroll Wheel + Right-Click</b> → <b>Drag Mouse Slowly</b> → <b>Release</b>',
...
export const ROTATE_VIEW_WRITTEN_TUTORIAL_STEPS: WrittenTutorialStep[] = [
  {
    ...
    text: '\n* See the model from different angles.\n* Inspect hidden or hard-to-see areas.\n* Better understand the model\'s 3D shape.',
    preserveText: true,
  },
