...
export const ORIGIN_AXES_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  ...
  quickReviewText: '<b>Locate Origin (0, 0, 0)</b> → <b>X Axis (Red)</b> → <b>Y Axis (Green)</b> → <b>Z Axis (Blue)</b>',
...
export const ORIGIN_LAYOUT_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  ...
  procedureTitle: 'Procedure',
  quickReviewTitle: 'Quick Review',
  quickReviewText: '<b>Select Component</b> → <b>Change Part Layout</b> → <b>Specify Alignment Point</b> → <b>Confirm</b>',
