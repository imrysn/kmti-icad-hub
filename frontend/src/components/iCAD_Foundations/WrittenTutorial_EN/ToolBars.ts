...
export const TOOLBARS_WRITTEN_TUTORIAL_COPY: WrittenTutorialCopy = {
  title: 'Tool Bars',
  description: 'provide quick access to commonly used iCAD SX commands. They help you navigate the workspace, control the view, edit your work, and perform modeling operations.',
  moduleLabel: '',
