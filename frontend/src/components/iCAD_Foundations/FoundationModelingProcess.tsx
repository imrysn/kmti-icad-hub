...
import { Box, Hexagon, Ruler, MapPin, CheckCircle, Move, MousePointer2, Copy, Trash2, CheckSquare, Undo2, RotateCw, FlipHorizontal } from 'lucide-react';
