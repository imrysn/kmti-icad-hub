...
export const cylinderTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: "",
    customText: "From the Icon Menu, open Shape Placement, then select Place Cylinder.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "Select Front View from the 3D View Toolsbar.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "From the Command Menu, confirm Cylinder, Placement, and Diameter Specification, then select Y Orientation.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "After the knowledge check, in the Key Entry Area, enter zero, zero, zero to place the cylinder at the model origin. Then click Enter.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "Let's review. From the Icon Menu, you selected Shape Placement and Place Cylinder, set the Front View and Y Orientation, entered the diameter and height in Item Entry, and entered zero, zero, zero in the Key Entry Area to place the cylinder at the model origin.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
...
export const boxTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: "",
    customText: "To begin, from the Icon Menu, open Shape Placement.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "Select Place Box from Shape Placement.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "From the Command Menu, confirm Rectangular Solid, Placement, and Dimension Specification, then select Y Orientation.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "In the Key Entry Area, enter 0, 0, 0 to position the box at the model origin. Then click Enter.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    title: "Review the Result",
    text: "",
    customText: "The box is now created using the specified width, depth, height, and origin position.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
  ...
  },
  {
    ...
    title: "Box Recap",
    text: "",
    customText: "Let's review. From the Icon Menu, you selected Shape Placement and Place Box, selected Front View and Y Orientation, entered the width, depth, and height in Item Entry, and used zero, zero, zero to position the box at the model origin.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
...
export const polygonTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: "",
    customText: "From the Icon Menu, open Shape Placement, then select Place Polygonal Prism.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "From the Command Menu, confirm Polygonal Prism, Placement, and Dimension Specification, then select Y Orientation.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    text: "",
    customText: "In the Item Entry area, enter the number of sides, the path diameter, and the height.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    title: " Polygon Recap",
    text: "",
    customText: "Let's review. From the Icon Menu, you selected Shape Placement and Place Polygonal Prism, selected Front View and Y Orientation, entered the number of sides, path diameter, and height in Item Entry, and used zero, zero, zero to position the polygonal prism at the model origin.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
...
export const coneTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: "",
    customText: "From the Icon Menu, open Shape Placement, then select Place Cone.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
    ...
    videoEnd: 3.25,
    overlays: [
      { id: "cone-shape-arrangement", type: "highlight", startTime: 0.75, endTime: 1.6, target: { x: 0.908, y: 0.123, width: 0.071, height: 0.028 }, animation: "pulse", label: "Shape Placement", labelPosition: "top" },
  ...
  },
  {
    ...
    text: "",
    customText: "From the Command Menu, confirm Cone and Placement, then select Y Orientation.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    title: "Cone Recap",
    text: "",
    customText: "Let's review. From the Icon Menu, you selected Shape Placement and Place Cone, selected Front View and Y Orientation, entered the base diameter, top face diameter, and height in Item Entry, and used zero, zero, zero to position the cone at the model origin.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
    ...
    recapData: {
      title: "Cone Complete",
      items: [
        "From the Icon Menu, opened Shape Placement and selected Place Cone.",
        "Selected Front View and Y Orientation.",
...
export const torusTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    text: "",
    customText: "From the Icon Menu, open Shape Placement, then select Place Torus.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
    ...
    videoEnd: 3.25,
    overlays: [
      { id: "torus-shape-arrangement", type: "highlight", startTime: 1.8, endTime: 2.2, target: { x: 0.908, y: 0.123, width: 0.071, height: 0.028 }, animation: "pulse", label: "Shape Placement", labelPosition: "top" },
  ...
  },
  {
    ...
    text: "",
    customText: "From the Command Menu, confirm Torus and Placement, then select Y Orientation.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
  ...
  },
  {
    ...
    title: "Torus Recap",
    text: "",
    customText: "Let's review. From the Icon Menu, you selected Shape Placement and Place Torus, selected Front View and Y Orientation, entered the section diameter, path radius, and turn angle in Item Entry, and used zero, zero, zero to position the torus at the model origin.",
    zoom: "scale(1)",
    origin: "center",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "100%", opacity: 0 },
    subtitlePos: { top: "82%", left: "50%", transform: "translateX(-50%)" },
    ...
    recapData: {
      ...
      items: [
        "From the Icon Menu, selected Shape Placement and Place Torus.",
