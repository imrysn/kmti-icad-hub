...
export const PROFESSIONAL_SHAPE_SCREENS: Record<PlacementShape, ShapeScreen> = {
  box: { src: box, front: [840, 45, 26, 26], orientation: [26, 948, 48, 36], placement: [1783, 165, 29, 29], itemEntry: [124, 1011, 462, 52], keyEntry: [1736, 1011, 184, 52] },
  cylinder: { src: cylinder, front: [840, 45, 26, 26], orientation: [26, 930, 48, 36], placement: [1752, 164, 27, 30], itemEntry: [124, 1011, 315, 52], keyEntry: [1736, 1011, 184, 52] },
  polygon: { src: polygon, front: [840, 45, 26, 26], orientation: [35, 943, 30, 18], placement: [1816, 164, 27, 30], itemEntry: [137, 1027, 398, 23], keyEntry: [1753, 1027, 161, 23] },
  // Cone (円錐台) is row 2, column 1 of the expanded Shape Placement palette.
  cone: { src: cone, front: [840, 45, 26, 26], orientation: [26, 947, 48, 36], placement: [1752, 197, 27, 30], itemEntry: [124, 1010, 518, 52], keyEntry: [1736, 1010, 184, 52] },
  // Torus is row 2, column 2, beside Cone.
  torus: { src: torus, front: [840, 45, 26, 26], orientation: [26, 948, 48, 36], placement: [1784, 197, 27, 30], itemEntry: [124, 1011, 532, 52], keyEntry: [1736, 1011, 184, 52] },
};
