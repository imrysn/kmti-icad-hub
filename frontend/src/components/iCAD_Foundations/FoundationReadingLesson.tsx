...
export default function FoundationReadingLesson({ lesson, onComplete, onNext, onPrevious, isLast, tutorial, completed = false }: Props) {
  ...
  return <div ref={containerRef} className={`course-lesson-container foundations-standard-intro foundations-video-reading-lesson foundations-consistent-lesson${['F9', 'P7'].includes(lesson.moduleId) ? ' foundations-modeling-lesson' : ''}`}>
    <>
