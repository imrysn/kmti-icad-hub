 ...
 *
 * Lesson-item ID: 'origin'
 * No sub-lessons.
 * Tabs: Standard Projections | Change 3D Part Layout
 *
 * Teaches users what the origin point is in iCAD and how to
 * reposition it using the "Change 3D Part Layout" tool.
 */
import React, { useState } from 'react';
import { MousePointer2, Info, ChevronLeft, ChevronRight } from 'lucide-react';
import '../../styles/3DModeling/CourseLesson.css';
import '../../styles/3DModeling/3DOrigin.css';
  ...
  return (
    <div className="course-lesson-container">
      <section className="lesson-intro">
        <h3><MousePointer2 size={28} className="text-blue-600" /> ORIGIN</h3>
        ...
        {activeTab === 'layout' && (
          <div className="lesson-card tab-content">
            ...
            <div className="instruction-step">
              ...
              <p>Select the <strong>Change 3D Part Layout</strong> from the icon menu.</p>
