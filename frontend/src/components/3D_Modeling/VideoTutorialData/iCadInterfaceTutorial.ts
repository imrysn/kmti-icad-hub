...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "0%", left: "0%", width: "100%", height: "1.8%", opacity: 1 },
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "1.7%", left: "0%", width: "100%", height: "2.5%", opacity: 1 },
    subtitlePos: { top: "10%", left: "50%", transform: "translateX(-50%)" }
  },
  {
    id: 5,
    title: "Command Menu",
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "8.5%", left: "10%", width: "10%", height: "81.5%", opacity: 1 },
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "8.5%", left: "20%", width: "75%", height: "81.5%", opacity: 1 },
    subtitlePos: { bottom: "15%", left: "50%", transform: "translateX(-50%)" }
  },
  {
    id: 8,
    title: "Icon Menu",
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "90%", left: "30%", width: "30%", height: "10%", opacity: 1 },
    subtitlePos: { bottom: "12%", left: "35%" }
  },
  {
    id: 4,
    title: "Tool Bar",
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "4%", left: "0%", width: "100%", height: "4.5%", opacity: 1 },
  ...
  },
  {
    ...
    zoom: "scale(1)",
    origin: "50% 50%",
    spotlight: { top: "90%", left: "60%", width: "40%", height: "10%", opacity: 1 },
    subtitlePos: { bottom: "12%", right: "5%" }
  }
];
