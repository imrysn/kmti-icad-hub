  ...
  return (
    <div className="course-lesson-container" ref={containerRef}>
      ...
      <section className="lesson-intro">
        ...
        <p className="p-flush">
          We have standard tools for creating holes such as drill holes, tapping
          holes and counterbores on the parts.
        </p>
        ...
        <div className="lesson-card tab-content">
          ...
          <div className="tab-content-area">
            <div className="tab-pane">
              <div
                className={getStepClass("hole-1")}
                onClick={() => toggleStep("hole-1")}
              >
                <div className="step-header">
                  {" "}
                  <span
                    className={`step-number ${completedSteps.has("hole-1") ? "completed" : ""}`}
                  >
                    {" "}
                    {completedSteps.has("hole-1") ? (
                ...
                >
                  <div className="image-wrapper-flush">
                    <img
                      src={arrangeMachinePart}
                      alt="Arrange Machine Part"
              ...
              <div
                className={getStepClass("hole-2")}
                onClick={() => toggleStep("hole-2")}
              >
                <div className="step-header">
                  {" "}
                  <span
                    className={`step-number ${completedSteps.has("hole-2") ? "completed" : ""}`}
                  >
                    {" "}
                    {completedSteps.has("hole-2") ? (
                      <CheckCircle2 size={16} />
                    ) : (
                      "2"
                    )}{" "}
              ...
              <div
                className={getStepClass("hole-3")}
                onClick={() => toggleStep("hole-3")}
              >
                <div className="step-header">
                  {" "}
                  <span
                    className={`step-number ${completedSteps.has("hole-3") ? "completed" : ""}`}
                  >
                    {" "}
                    {completedSteps.has("hole-3") ? (
                      <CheckCircle2 size={16} />
                    ) : (
                      "3"
                    )}{" "}
                  ...
                  <span className="step-label">
                    After setting the specifications, click{" "}
                    <strong className="text-highlight">OK</strong>.
                  </span>
                </div>
              ...
              <div
                className={getStepClass("hole-4")}
                onClick={() => toggleStep("hole-4")}
              >
                <div className="step-header">
                  {" "}
                  <span
                    className={`step-number ${completedSteps.has("hole-4") ? "completed" : ""}`}
                  >
                    {" "}
                    {completedSteps.has("hole-4") ? (
                      <CheckCircle2 size={16} />
                    ) : (
                      "4"
                    )}{" "}
                  ...
                  <span className="step-label">
                    Click the location of the hole on the solid entity &gt;{" "}
              ...
              <div className="info-box">
                <p className="p-flush">
                  <strong className="text-highlight">Note:</strong> Tapped holes
                  must be painted green to indicate that those are threaded and
                  to distinguish it from drill holes.
                </p>

                <div className="image-wrapper-flush">
                  <img
                    src={tappedHoles}
                    alt="Tapped Holes Examples"
                    className="software-screenshot screenshot-wide"
                  />
                </div>
              </div>
