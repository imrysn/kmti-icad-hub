      ...
      <div className="lesson-grid single-card">
        {activeTab === "workPlane" && (
          <div className="lesson-card tab-content">
            ...
            <p className="lesson-subtitle">3D modeling can be done by sketching on 2D sketch using a plane on the 3D Dimension.</p>
            <p>To create 2D plane on the 3D Dimension, use <strong className="text-highlight">Open Work Plane</strong> from the toolbar.</p>
            ...
            <div className="tool-block">
              ...
              <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}>
                ...
                <div className="step-description">
                  <div className="screenshot-wrapper">
                    <img src={openWorkPlaneImg2} alt="Open Work Plane" className="software-screenshot screenshot-small" style={{ width: '15rem' }} />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="lesson-grid single-card">
        {activeTab === "commandMenu" && (
          <div className="lesson-card tab-content">
            ...
            <p className="lesson-subtitle">Most tools used for sketching on the work plane can be found on the command menu.</p>
            <div className="tool-block">
              <div className="screenshot-wrapper">
      ...
      <div className="lesson-grid single-card">
        {activeTab === "extrude" && (
          <div className="lesson-card tab-content">
            ...
            <p className="lesson-subtitle"> Creates a solid entity from a section form created on a work plane or 2D drawing, by performing vertical at projection. </p>
            ...
            <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}>
              ...
              <div className="step-description">
                <div className="screenshot-wrapper">
                  <img src={pickCrossSection} alt="PICK EDGE" className="software-screenshot screenshot-large" style={{ width: '480px', height: 'auto' }} />
                </div>
              </div>
            </div>
        ...
        {activeTab === "revolve" && (
          <div className="lesson-card tab-content">
            ...
            <p className="lesson-subtitle"> Creates a solid entity from a section from created on a work plane or 2D drawing, by performing rotation projection. </p>
            <div className={`instruction-step ${currentIndex === 0 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 1 </span> <span className="step-label"> Select <strong className="text-highlight">Revolve</strong> from the icon menu. </span> </div>
              <div className="step-description">
                <div className="screenshot-wrapper">
            ...
            <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 2 </span> <span className="step-label"> Pick the cross-section to be revolved&gt; <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" style={{ width: '40px', verticalAlign: 'middle', margin: '0 4px' }} /> </span> </div>
              <p className="p-flush"> A hatch will appear to show that the sketch is an enclosed figure </p>
            </div>
            <div className={`instruction-step ${currentIndex === 2 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 3 </span> <span className="step-label"> Select the axis of rotation &gt; <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" style={{ width: '40px', verticalAlign: 'middle', margin: '0 4px' }} /> </span> </div>
            </div>
            <div className="tool-block">
              <div className="screenshot-wrapper">
        ...
        {activeTab === "spiral" && (
          <div className="lesson-card tab-content">
            ...
            <p className="lesson-subtitle"> Creates a 3D spiral form from a section form created on a 2D sketch. </p>
            <div className={`instruction-step ${currentIndex === 0 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 1 </span> <span className="step-label">First do the sketch.</span> </div>
              <div className="step-description">
                <div className="screenshot-wrapper">
            ...
            <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 2 </span> <span className="step-label"> Select <strong className="text-highlight">Spiral Form</strong> from the icon menu </span> </div>
              <div className="step-description">
                <div className="screenshot-wrapper">
                  <img src={spiralIcon} alt="Spiral Form Icon" className="software-screenshot screenshot-small" style={{ height: '170px' }} />
                </div>
                <p className="text-caption"> Pick the cross section to be revolved. Hatch will appear to show that the sketch is an enclosed figure &gt; GO </p>
              </div>
            </div>
            <div className={`instruction-step ${currentIndex === 2 ? "reading-active" : ""}`}>
              ...
              <div className="step-description">
                <p className="p-flush"> *Note: Pitch must be greater than Thickness </p>
                <div className="screenshot-wrapper">
                  <img src={spiralItemEntry} alt="Spiral Item Entry" className="software-screenshot screenshot-large" style={{ height: '110px' }} />
                </div>
            ...
            <div className={`instruction-step ${currentIndex === 3 ? "reading-active" : ""}`}>
              <div className="step-header"> <span className="step-number"> 4 </span> <span className="step-label"> Select the ends of the length of the spiral along the axis of rotation. Then <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" style={{ width: '40px', verticalAlign: 'middle', margin: '0 4px' }} /> </span> </div>
              <div className="step-description">
                <div className="screenshot-wrapper">
                  <img src={spiralRotation1} alt="Spiral Axis 1" className="software-screenshot screenshot-medium" style={{ width: '350px' }} />
                </div>
              </div>
            </div>
