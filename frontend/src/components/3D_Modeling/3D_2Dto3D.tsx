        ...
        {activeTab === "workPlane" && ( 
          <div className="lesson-card tab-content"> 
            ...
            <div className="tool-block"> 
              <div className="image-wrapper-flush"> <img src={workPlaneImg} alt="X-Y Plane" className="software-screenshot screenshot-small" /> </div> 
              ...
              <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`} style={{ marginTop: '1.5rem' }}> 
                ...
                <div className="step-description" style={{ paddingLeft: '2.5rem' }}> <div className="flex-row-center"> <div className="image-wrapper-flush"> <img src={openWorkPlaneImg2} alt="Open Work Plane" className="software-screenshot screenshot-small" /> </div> </div> </div> 
              </div> 
            </div> 
      ...
      <div className="lesson-grid single-card"> 
        {activeTab === "commandMenu" && ( 
          <div className="lesson-card tab-content"> 
            ...
            <div className="tool-block"> 
              <div className="image-wrapper-flush"> These are the tools used for extruding 2D sketches to 3D solid Entities. <img src={commandMenu} alt="Command Menu" className="software-screenshot screenshot-wide" /> </div> 
            </div> 
            <div className="lesson-navigation"> 
              <button className="nav-button" onClick={onPrevLesson}> <ChevronLeft size={18} /> Previous </button> 
              <button className="nav-button next" onClick={onNextLesson}> {nextLabel || 'Next Lesson'} <ChevronRight size={18} /> </button> 
      ...
      <div className="lesson-grid single-card"> 
        {activeTab === "extrude" && ( 
          <div className="lesson-card tab-content"> 
            ...
            <div className="tool-block"> <div className="image-wrapper-flush"> <img src={commandMenu2} alt="Extrude Tools" className="software-screenshot screenshot-small" /> </div> </div> 
            ...
            <div className={`instruction-step ${currentIndex === 0 ? "reading-active" : ""}`}> 
              ...
              <div className="step-description"> <div className="image-wrapper-flush"> <img src={extrudeIcon} alt="Extrude Icon Menu" className="software-screenshot screenshot-small" /> </div> </div> 
            </div> 
            <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}> 
              <div className="step-header"> <span className="step-number"> 2 </span> <span className="step-label"> Pick the cross-section to be extruded. A hatch will appear to show that the sketch is an enclosed figure &gt; <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" /> </span> </div> 
            ...
            <div className={`instruction-step ${currentIndex === 2 ? "reading-active" : ""}`}> 
              <div className="step-header"> <span className="step-number"> 3 </span> <span className="step-label"> Specify the height of extrusion on the item entry &gt; Press <strong className="text-highlight">Enter</strong> &gt; <strong className="text-highlight">GO</strong> </span> </div> 
            </div> 
        ...
        {activeTab === "revolve" && ( 
          <div className="lesson-card tab-content"> 
            ...
            <div className={`instruction-step ${currentIndex === 0 ? "reading-active" : ""}`}> <div className="step-header"> <span className="step-number"> 1 </span> <span className="step-label"> Select <strong className="text-highlight">Revolve</strong> from the icon menu. </span> </div> <div className="step-description"> <div className="image-wrapper-flush"> <img src={revolveIcon} alt="Revolve Icon" className="software-screenshot screenshot-small" /> </div> </div> </div> 
            <div className={`instruction-step ${currentIndex === 1 ? "reading-active" : ""}`}> <div className="step-header"> <span className="step-number"> 2 </span> <span className="step-label"> Pick the cross-section to be revolved. A hatch will appear to show that the sketch is an enclosed figure &gt; <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" /> </span> </div> <p className="p-flush-bottom"> A hatch will appear to show that the sketch is an enclosed figure </p> </div> 
            <div className={`instruction-step ${currentIndex === 2 ? "reading-active" : ""}`}> <div className="step-header"> <span className="step-number"> 3 </span> <span className="step-label"> Select the axis of rotation &gt; <strong className="text-highlight">GO</strong> <img src={leftClick} alt="Left click" className="screenshot-click--inline" /> </span> </div> </div> 
            <div className="tool-block"> <div className="image-wrapper-flush"> <img src={revolveSteps} alt="Revolve Steps" className="software-screenshot screenshot-wide" /> </div> </div> 
            <div className="lesson-navigation"> <button className="nav-button" onClick={handlePrev}> <ChevronLeft size={18} /> Previous </button> <button className="nav-button next" onClick={handleNext}> {nextLabel || 'Next'} <ChevronRight size={18} /> </button> </div> 
          </div> 
        )} 
        {activeTab === "spiral" && ( 
