        ...
        {activeTab === 'showHide' && (
          <div className="lesson-card tab-content">
            ...
            <div className="instruction-step" style={{ marginTop: '1rem' }}>
              ...
              <p className="p-flush">1. Select Show/Hide from the icon menu.</p>
            ...
            <div className="instruction-step section-divider-sm">
              ...
              <p className="p-flush">1. Select Show/Hide Drafting Entity from the icon menu.</p>
            ...
            <div className="instruction-step section-divider-sm">
              ...
              <div className="flex-row">
                <div className="flex-1">
                  <p className="p-flush">1. Select Hide Unselected Entity from the icon menu.</p>
