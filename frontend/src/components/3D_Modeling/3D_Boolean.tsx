...
} /* Sub-components Boolean1 and Boolean2 were integrated into the main BooleanLesson component for better structure. */ const BooleanLesson: React.FC<BooleanLessonProps> = ({ subLessonId, onNextLesson, onPrevLesson, nextLabel }) => {
