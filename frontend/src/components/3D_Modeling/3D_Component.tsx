    ...
    <div className="course-lesson-container" ref={containerRef}>
      ...
      <section className="lesson-intro">
        ...
        <div className="instruction-box">
          <div className="image-wrapper-flush"><img src={componentMenu} alt="Component Operation Menu" className="software-screenshot screenshot-small" style={{ width: '230px' }} /></div>
        </div>
      </section>
            ...
            {activeTab === 'move' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={moveIcon} alt="Move Component Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                ...
                <div className={`instruction-step ${currentIndex === 2 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={moveEntry} alt="Move Item Entry" className="software-screenshot screenshot-large" style={{ width: '500px' }} /></div>
                </div>
            ...
            {activeTab === 'copy' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={copyIcon} alt="Copy Component Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
                ...
                <div className={`instruction-step ${currentIndex === 2 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={copyFinal} alt="Copy Result" className="software-screenshot screenshot-large" style={{ width: '670px' }} /></div>
                  <br />
                </div>
                <div className="tool-block"><h4 className="section-title" style={{ marginRight: '810px' }}>Result</h4><div className="image-wrapper-flush"><img src={copyDistance} alt="Copy Distance" className="software-screenshot screenshot-medium" /></div></div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
            {activeTab === 'mirror' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={mirrorIcon} alt="Mirror Component Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
                ...
                <div className={`instruction-step ${currentIndex === 2 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={mirrorResult} alt="Mirror Result" className="software-screenshot screenshot-medium" style={{ width: '500px' }} /></div>
                </div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
            {activeTab === 'rotate' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={rotateIcon} alt="Rotate Component Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
                ...
                <div className={`instruction-step ${currentIndex === 3 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={rotateEntry} alt="Rotate Entry" className="software-screenshot screenshot-large" style={{ width: '650px' }} /></div>
                </div>
                <div className="tool-block"><h4 className="section-title">Result</h4><div className="image-wrapper-flush"><img src={rotateResult} alt="Rotate Result" className="software-screenshot screenshot-medium" style={{ width: '650px' }} /></div></div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
          </div>
  ...
  return (
    <div className="course-lesson-container" ref={containerRef}>
      ...
      <section className="lesson-intro">
        ...
        <p className="p-flush">These tools are used to change the position, duplicate or delete components such as drill holes, cutouts, components of merged entities.</p>
        <div className="instruction-box">
          <div className="image-wrapper-flush"><img src={componentMenu} alt="Component Operation Menu" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
        </div>
      </section>
      <div className="lesson-grid single-card">
        <div className="lesson-card tab-content">
          <div className="tab-content-area">
            {activeTab === 'repeat' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={repeatCopyIcon} alt="Repeat Copy Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={repeatCopyResult} alt="Repeat Copy Result" className="software-screenshot screenshot-wide" style={{ width: '905px' }} /></div>
                </div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
            {activeTab === 'rotateCopy' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  <div className="step-header"><span className="step-number">1</span><span className="step-label">Select <strong className="text-highlight">Rotate Component</strong> from the icon menu.</span></div>
                  <div className="image-wrapper-flush"><img src={rotateCopyIcon} alt="Rotate Copy Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
                ...
                <div className={`instruction-step ${currentIndex === 2 ? 'reading-active' : ''}`}>
                  <div className="step-header"><span className="step-number">3</span><span className="step-label">Select 2 points to set the axis of rotation.</span></div>
                  <div className="image-wrapper-flush"><img src={rotateCopyPoints} alt="Rotate Copy Points" className="software-screenshot screenshot-wide" style={{ width: '700px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 3 ? 'reading-active' : ''}`}>
                  <div className="step-header"><span className="step-number">4</span><span className="step-label">Specify the angle of rotation on the item entry &gt; Press <strong className="text-highlight">Enter</strong></span></div>
                  <div className="image-wrapper-flush"><img src={rotateCopyEntry} alt="Rotate Copy Entry" className="software-screenshot screenshot-wide" style={{ width: '800px' }} /></div>
                </div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
            {activeTab === 'mirrorCopy' && (
              <div className="fade-in">
                ...
                <div className="image-wrapper-flush"><img src={mirrorCopyIcon} alt="Mirror Copy Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                <br />
                <br />
                <br />

                <div className="image-wrapper-flush"><img src={mirrorCopyResult} alt="Mirror Copy Result" className="software-screenshot screenshot-large" style={{ width: '650px' }} /></div>
                <div className="lesson-navigation"><button className="nav-button" onClick={handlePrev}><ChevronLeft size={18} /> Previous</button><button className="nav-button next" onClick={handleNext}>{nextLabel || 'Next'} <ChevronRight size={18} /></button></div>
              </div>
            )}
            {activeTab === 'delete' && (
              <div className="fade-in">
                ...
                <div className={`instruction-step ${currentIndex === 0 ? 'reading-active' : ''}`}>
                  ...
                  <div className="image-wrapper-flush"><img src={deleteIcon} alt="Delete Component Icon" className="software-screenshot screenshot-small" style={{ width: '250px' }} /></div>
                </div>
                <div className={`instruction-step ${currentIndex === 1 ? 'reading-active' : ''}`}>
