                    ...
                    <div className="instruction-step">
                        <div className="step-header">
                            ...
                            <span className="step-label">
                                ...
                                <span className="image-wrapper-flush">
                                    <img src={upImg} alt="Unsuppress" style={{ height: '24px', verticalAlign: 'middle' }} />
                                </span>
                            </span>
                        </div>
                        <div className="step-description">
                        ...
                        <div className="step-description">
                            <div className="instruction-box" style={{ marginTop: '1rem', marginBottom: '1.5rem', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)', padding: '1rem 0' }}>
                                <p className="p-flush red-text">
                                    ...
                                    <span className="image-wrapper-flush">
                                        <img src={downImg} alt="Suppress" style={{ height: '24px', verticalAlign: 'middle' }} />
                                    </span>
                                    {' '}or just click{' '}
                                    <span className="image-wrapper-flush">
                                        <img src={boxImg} alt="Flat-Pattern box" style={{ height: '24px', verticalAlign: 'middle' }} />
                                    </span>
                                </p>
                            </div>
                            <div className="image-wrapper" style={{ marginTop: '1.5rem', marginBottom: '1.5rem' }}>
