            ...
            <div className="step-header" style={{padding:'8px 0px'}}>
                ...
                <span className="step-label">
                    ...
                    <span className="image-wrapper-flush">
                        <img src={rebuildImg} alt="Rebuild" style={{ height: '45px', verticalAlign: 'middle' }} />
                    </span>
        ...
        <div className="instruction-step">
            <div className="step-header"  style={{padding:'8px 0px'}}>
                ...
                <span className="step-label">
                    ...
                    <span className="image-wrapper-flush">
                        <img src={filePropertiesImg} alt="File Properties" style={{ height: '45px', verticalAlign: 'middle' }} />
                    </span>
                </span>
            </div>
        </div>
