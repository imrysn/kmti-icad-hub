...
const TwoDStandardLesson: React.FC<TwoDStandardLessonProps> = ({
  ...
  const [centerGalleryImageVertically, setCenterGalleryImageVertically] = useState(false);
  ...
  useEffect(() => {
    resetZoomPan();
    setCenterGalleryImageVertically(false);
      ...
      {subLessonId === '2d-gallery' && (
        <div className="gallery-section-wrapper" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
          ...
          >
            ...
            {/* Gallery image anchored to the top of the viewport */}
            <div style={{
              transform: `translate(${pan.x}px, ${pan.y}px) scale(${zoom})`,
              transformOrigin: centerGalleryImageVertically ? "center center" : "center top",
              transition: isPanningRef.current ? "none" : "transform 0.05s ease-out",
              display: "flex",
              alignItems: centerGalleryImageVertically ? "center" : "flex-start",
              justifyContent: "center",
              width: "100%",
              height: "100%",
            }}>
              {galleryImages[galleryIndex].content ? (
                ...
                <img
                  ...
                  onLoad={(event) => {
                    ...
                    setCenterGalleryImageVertically((image.naturalWidth / image.naturalHeight) >= (1000 / 640));
                  }}
                  style={{
                    display: "block",
                    width: centerGalleryImageVertically ? "auto" : "100%",
                    height: centerGalleryImageVertically ? "100%" : "auto",
                    maxWidth: "none",
                    maxHeight: "none",
                    flexShrink: 0,
                    pointerEvents: "none",
          ...
          {/* Zoom indicator (bottom-left) */}
            ...
            >
              ...
              <div className="gallery-browse-anchor" style={{ position: "relative" }}>
                ...
                {showMenu && (
                  <div ref={fsBrowseDropdownRef} className="gallery-browse-dropdown" style={{
                    position: "absolute",
                    ...
                    <div className="gallery-browse-header" style={{
                      ...
                      <span className="gallery-browse-title">{typeof galleryImages[galleryIndex].label === "string" ? galleryImages[galleryIndex].label : "2D Standard Reference"}</span>
                    ...
                    {galleryImages.map((img, idx) => (
                      ...
                      >
                        <span className="gallery-browse-number" style={{
