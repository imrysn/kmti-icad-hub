...
import { AlertCircle,CheckCircle2,ChevronRight,Clock,Download,FileSpreadsheet,FileText,Folder,HelpCircle,Lock,LogOut,Play,RotateCcw,Trash2,Upload,UploadCloud,Zap } from 'lucide-react';
...
import '../../../components/3D_Modeling/CourseLesson.css';
import './PracticalAssessment.css';
                                                                                                    ...
                                                                                                    <div className="feedback-details" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '0.5rem' }}>
                                                                                                        {feedbackSubmission.feedback.map((fb, fIdx) => (
                                                                                                            <div key={fb.id} className="chat-container" style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', width: '100%' }}>
                                                                                                                ...
                                                                                                                {fb.comments && (
                                                                                                                    <div className="feedback-comment chat-bubble trainer-chat" style={{ background: 'linear-gradient(145deg, var(--color-primary-glow), transparent)', border: '1px solid var(--primary)', padding: '1rem', borderRadius: '12px 12px 12px 0', width: 'fit-content', maxWidth: '90%', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', borderLeft: 'none' }}>
                                                                                                                        <span className="chat-author" style={{ fontSize: '0.75rem', color: 'var(--primary)', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '6px', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}><div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--primary)' }} /> Trainer</span>
                                                                                                                        ...
                                                                                                                        {fb.checkback_file_path && (
                                                                                                                            <div className="feedback-file-actions" style={{ display: 'flex', gap: '0.5rem', marginTop: '0.75rem', alignItems: 'center' }}>
                                                                                                                                <button
                                                                                                                                    ...
                                                                                                                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '0.8rem', color: 'var(--primary)', padding: '6px 10px', background: 'var(--color-primary-glow)', border: 'none', borderRadius: '6px', transition: 'all 0.2s', fontWeight: 600, cursor: 'pointer' }}
                                                                                                                                >
                                                                                                                                ...
                                                                                                                                <a
                                                                                                                                    ...
                                                                                                                                    style={{ padding: '6px', background: 'var(--color-primary-glow)', borderRadius: '6px', color: 'var(--primary)', display: 'inline-flex', alignItems: 'center', transition: 'all 0.2s' }}
                                                                                                                                >
                                                                                                                                    <Download size={14} />
                                                                                                                                </a>
                                                                                                                            </div>
