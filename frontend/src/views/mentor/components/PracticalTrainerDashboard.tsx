                                                            ...
                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                                                {sub.feedback.map(fb => (
                                                                    <div key={fb.id} className="chat-container" style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                                                        <div className="chat-bubble trainer-chat" style={{ background: 'linear-gradient(145deg, var(--color-primary-glow), transparent)', border: '1px solid var(--primary)', padding: '1rem', borderRadius: '12px 12px 0 12px', width: 'fit-content', maxWidth: '90%', alignSelf: 'flex-end', marginLeft: 'auto', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                                                                            <span className="chat-author" style={{ fontSize: '0.75rem', color: 'var(--primary)', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '6px', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{t('review.you_trainer')} <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--primary)' }} /></span>
                                                                            ...
                                                                            {fb.checkback_file_path && (
                                                                                <div className="chat-attachment" onClick={() => handleDownloadCheckback(fb)} style={{ cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '0.8rem', color: 'var(--primary)', marginTop: '0.75rem', padding: '6px 10px', background: 'var(--color-primary-glow)', borderRadius: '6px', transition: 'all 0.2s', fontWeight: 600 }}
                                                                                    onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--primary)'; e.currentTarget.style.color = '#fff'; }}
                                                                                    onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--color-primary-glow)'; e.currentTarget.style.color = 'var(--primary)'; }}
                                                                                >
