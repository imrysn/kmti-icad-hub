...
import { X, Folder, File as FileIcon, Upload, FolderPlus, Trash2 } from 'lucide-react';
...
export const FileManagerModal: React.FC<FileManagerModalProps> = ({ task, onClose }) => {
    ...
    return (
        <div className="admin-modal-overlay">
            <div className="admin-modal-card animate-slide-up" style={{ maxWidth: '600px', width: '100%' }}>
                <div className="modal-header">
                    <h3>Manage Files: {task.title} (Set {task.set_number} - {task.task_code})</h3>
